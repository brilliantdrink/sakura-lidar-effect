...
const NumberFieldIncrementTrigger = <T extends ValidComponent = "button">(
  ...
  return (
    <NumberFieldPrimitive.IncrementTrigger
      class={cn(
        "absolute right-2 top-1.5 h-5 inline-flex size-4 items-center justify-center",
        local.class
      )}
      {...others}
    >
...
const NumberFieldDecrementTrigger = <T extends ValidComponent = "button">(
  ...
  return (
    <NumberFieldPrimitive.DecrementTrigger
      class={cn(
        "absolute bottom-1.5 right-2 h-5 inline-flex size-4 items-center justify-center",
        local.class
      )}
      {...others}
    >
